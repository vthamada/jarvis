...
- criada a matriz regeneravel `docs/archive/implementation/v2-governed-benchmark-matrix.md` via `tools/archive/render_governed_benchmark_matrix.py`;
...
- o corte agora possui uma matriz regeneravel de benchmark governado por familia em `docs/archive/implementation/v2-governed-benchmark-matrix.md`;
...
- `tools/archive/close_domain_consumers_and_workflows_cut.py` passou a consolidar o fechamento do corte em artefatos regeneraveis;
