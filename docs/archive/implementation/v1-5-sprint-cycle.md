...
- `tools/archive/close_stateful_runtime_cycle.py` passou a gerar artefatos executáveis de fechamento do ciclo com evidência observável e comparativa do runtime;
