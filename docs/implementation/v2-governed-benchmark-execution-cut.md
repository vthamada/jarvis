...
- `docs/implementation/v2-domain-consumers-and-workflows-cut-closure.md` ja fechou consumidores, workflows e benchmark governance como baseline `release-grade`;
- `tools/verify_active_cut_baseline.py` e `tools/close_domain_consumers_and_workflows_cut.py` ja existem como verificadores regeneraveis do corte anterior;
- `docs/implementation/v2-governed-benchmark-matrix.md` ja define o envelope completo e fixa `Mastra`, `AutoGPT Platform` e `Mem0` como `benchmark_now`;
...
- criado renderizador `tools/render_governed_benchmark_execution_plan.py`;
- criado artefato regeneravel `docs/implementation/v2-governed-benchmark-execution-plan.md` com superficies baseline, perguntas de avaliacao, artefatos esperados e bloqueios de absorcao por tecnologia.
...
- artefato regeneravel em `docs/implementation/v2-governed-benchmark-scenario-specs.md`.

Entrega realizada:

- criado dataset versionado em `tools/benchmarks/datasets/v2_governed_benchmark_scenarios.json`;
- criado renderizador `tools/render_governed_benchmark_scenario_specs.py`;
- criado artefato regeneravel `docs/implementation/v2-governed-benchmark-scenario-specs.md` com scenario id, objetivo, sinais de sucesso/falha, evidencia minima e fronteiras sandbox por tecnologia.
...
- criado renderizador `tools/render_governed_benchmark_decisions.py`;
- criado artefato regeneravel `docs/implementation/v2-governed-benchmark-decisions.md` com decisao final, racional curto, sinais de reabertura e superficies recomendadas por tecnologia;
...
- criado `tools/close_governed_benchmark_execution_cut.py` como fechador regeneravel do recorte;
- criado artefato formal `docs/implementation/v2-governed-benchmark-execution-cut-closure.md`;
...
- `docs/implementation/v2-governed-benchmark-execution-cut-closure.md` existir como fechamento humano do recorte;
- `tools/close_governed_benchmark_execution_cut.py` passar no gate de release como fechamento do corte atual;
...
- `docs/implementation/v2-governed-benchmark-execution-plan.md`
- `docs/implementation/v2-governed-benchmark-scenario-specs.md`
- `docs/implementation/v2-governed-benchmark-decisions.md`
- `docs/implementation/v2-governed-benchmark-execution-cut-closure.md`
