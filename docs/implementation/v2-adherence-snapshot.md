...
- `MB-160` foi fechado como repriorizacao pos-`MB-159` a partir de
  ...
  seguinte; `MB-191` a `MB-196` foram fechados e `MB-197` e o unico item
  tecnico `ready`.
