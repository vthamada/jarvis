...
- `MB-160` foi fechado como repriorizacao pos-`MB-159` a partir de
  ...
  seguinte; `MB-191` e `MB-192` foram fechados e `MB-193` e o unico item
  tecnico `ready`.
