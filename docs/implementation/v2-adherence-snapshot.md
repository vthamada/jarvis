...
- `MB-160` foi fechado como repriorizacao pos-`MB-159` a partir de
  ...
  `MB-174` tambem foi fechado; a fila esta esgotada e aguarda repriorizacao
  explicita pelo mapa mestre.
