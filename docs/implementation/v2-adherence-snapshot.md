...
- `MB-175` repriorizou o slice para pattern evidence, skills e workflows governados; `MB-176` a `MB-182` fecharam a cadeia de skill, versionamento imutavel e derivacao de variante apenas de evidencia revisada; `MB-183` inicia a comparacao offline baseline vs candidata.
