...
- `MB-175` repriorizou o slice para pattern evidence, skills e workflows governados; `MB-176` a `MB-181` fecharam a cadeia de skill e o versionamento imutavel de workflow; `MB-182` inicia a derivacao de variante apenas de evidencia revisada.
