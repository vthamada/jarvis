...
- `MB-160` foi fechado como repriorizacao pos-`MB-159` a partir de
  ...
  seguinte; `MB-191` a `MB-195` foram fechados e `MB-196` e o unico item
  tecnico `ready`.
