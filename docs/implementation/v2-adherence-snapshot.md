...
- `MB-160` foi fechado como repriorizacao pos-`MB-159` a partir de
  ...
  seguinte; `MB-191`, `MB-192` e `MB-193` foram fechados e `MB-194` e o unico item
  tecnico `ready`.
