...
- `MB-175` repriorizou o slice para pattern evidence, skills e workflows governados; `MB-176` fechou a deteccao auditavel de recorrencia antes de qualquer skill candidata, e `MB-177` formalizara o registry inativo.
...
- `MB-160` foi fechado como repriorizacao pos-`MB-159` a partir de
  ...
  fechado e `MB-177` e o unico item tecnico `ready`.
