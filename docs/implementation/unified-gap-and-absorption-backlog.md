...
2. tratar `MB-160` a `MB-183` como baseline fechado e executar `MB-184` como
   integracao da candidata avaliada aos gates humanos de promocao e rollback.
...
- `MB-160` abriu a fila maior `MB-161` a `MB-174`, priorizando memoria causal,
  ...
  `MB-189`; `MB-177` a `MB-183` tambem foram fechados e `MB-184` e o unico item `ready`;
