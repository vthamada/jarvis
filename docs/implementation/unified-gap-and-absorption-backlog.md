...
- `MB-160` foi fechado como repriorizacao pos-`MB-159` a partir do
  ...
  `MB-191` a `MB-200`, `MB-191` e `MB-192` foram fechados e `MB-193` e o unico item tecnico
  `ready`.
...
2. tratar `MB-160` a `MB-192` como baseline fechado e executar `MB-193` a
...
- `MB-160` abriu a fila maior `MB-161` a `MB-174`, priorizando memoria causal,
  ...
  `MB-191` a `MB-200`; `MB-191` e `MB-192` foram fechados e somente `MB-193` esta `ready`;
