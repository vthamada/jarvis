...
- `MB-160` foi fechado como repriorizacao pos-`MB-159` a partir do
  ...
  `MB-191` a `MB-200`, `MB-191` a `MB-196` foram fechados e `MB-197` e o unico item tecnico
  `ready`.
...
2. tratar `MB-160` a `MB-196` como baseline fechado e executar `MB-197` a
...
- `MB-160` abriu a fila maior `MB-161` a `MB-174`, priorizando memoria causal,
  ...
  `MB-191` a `MB-200`; `MB-191` a `MB-196` foram fechados e somente `MB-197` esta `ready`;
