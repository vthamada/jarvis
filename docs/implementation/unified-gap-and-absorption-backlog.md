...
2. tratar `MB-160` a `MB-184` como baseline fechado e executar `MB-185` como
   evidencia de adaptacao de routing/especialista sem mutar a rota ativa.
...
- `MB-160` abriu a fila maior `MB-161` a `MB-174`, priorizando memoria causal,
  ...
  `MB-189`; `MB-177` a `MB-184` tambem foram fechados e `MB-185` e o unico item `ready`;
