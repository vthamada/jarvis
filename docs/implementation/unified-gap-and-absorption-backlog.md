...
2. tratar `MB-160` a `MB-178` como baseline fechado e executar `MB-179` como
   review/eval sandbox da candidata, sem ativacao runtime.
...
- `MB-160` abriu a fila maior `MB-161` a `MB-174`, priorizando memoria causal,
  ...
  `MB-189`; `MB-177` e `MB-178` tambem foram fechados e `MB-179` e o unico item `ready`;
