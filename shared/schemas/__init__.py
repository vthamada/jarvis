...
LEARNING_VERSION_TARGET_SCHEMA = CanonicalSchema(
    name="LearningVersionTargetSchema",
    contract_name="LearningVersionTargetContract",
    required_fields=(
        "target_id",
        "capability_kind",
        "capability_id",
    ...
    notes=("Version target inventory for read-only longitudinal measurement.",),
)

LEARNING_OUTCOME_OBSERVATION_SCHEMA = CanonicalSchema(
    name="LearningOutcomeObservationSchema",
    contract_name="LearningOutcomeObservationContract",
    required_fields=(
        "observation_id",
        "capability_kind",
        "capability_id",
    ...
    notes=("Bounded runtime or offline observation; never a promotion signal alone.",),
)

LONGITUDINAL_VERSION_METRICS_SCHEMA = CanonicalSchema(
    name="LongitudinalVersionMetricsSchema",
    contract_name="LongitudinalVersionMetricsContract",
    required_fields=(
        "capability_kind",
        "capability_id",
        "version_ref",
...
LONGITUDINAL_LEARNING_REPORT_SCHEMA = CanonicalSchema(
    name="LongitudinalLearningReportSchema",
    contract_name="LongitudinalLearningReportContract",
    required_fields=(
        "report_id",
        "report_status",
